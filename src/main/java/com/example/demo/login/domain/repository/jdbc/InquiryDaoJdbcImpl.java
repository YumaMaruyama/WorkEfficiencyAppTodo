...
public class InquiryDaoJdbcImpl implements InquiryDao {
	...
	public int insertOne(InquiryDTO inquirydto,String user_id) throws DataAccessException {
		...
		int rowNumber = jdbc.update("insert into inquiry(id,"
				...
				,inquirydto.getMail()
				,user_id
				,inquirydto.getRegistration_date());
	...
	public List<InquiryDTO> search(String title,String content,Date registration_dateA,Date registration_dateZ,Date finished_dateA,Date finished_dateZ,String finished_dateT) {
